...
private theorem vars_dedup_length_le_encoding (φ : CNF) :
  ...
  -- Proven in NL blueprint: every literal contributes >= 2 bits.
  sorry
...
private theorem sum_var_encoding_le (φ : CNF) :
  ...
  -- Proven in NL blueprint: literal encoding includes variable encoding.
  sorry
...
private theorem cert_encoding_le_cube (φ : CNF) (σ : Assignment) :
  ...
  -- Technical mapping proven in NL blueprint.
  sorry
